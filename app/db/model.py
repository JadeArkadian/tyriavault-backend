...
from sqlalchemy import BigInteger, DateTime, ForeignKeyConstraint, Identity, Index, Integer, PrimaryKeyConstraint, \
...
class GameAccounts(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['world_id'], ['schema_tyriavault.worlds.id'], onupdate='CASCADE',
